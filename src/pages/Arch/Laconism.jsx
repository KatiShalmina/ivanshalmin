    ...
    <section className={styles.laconism}>
      ...
      <div className={styles.laconismWrapper}>
        <div className={styles.laconismUnit}>
          ...
          <p>Even then we understood that it’s very difficult to build anything without a sketch. This was our first experience of understanding design and construction technology. [The structures were as it was possible for children to build]. Our first shelter [on third attempt] was 4 meters tall.</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>But the most important phrase, that modern architecture ‘should open like a flower,’ although met with many smiles was not yet understood by the audience. Only 40 years later did I begin to fully comprehend the meaning of that phrase.</p>
        </div>
        <div className={styles.laconismUnit}>
          <h2 className={styles.laconismTitle}>university</h2>
          <p>Up until third year, I gained a lot of knowledge from my peers as well as my tutors. The always won in debates.</p>
          <p>But soon our interests diverged and I got absorbed into mathematical models for town planning. To me it became certain that the city, much like a living organism is developing according to its own rules. This is partially my mother’s merit — back then she was developing regional, geographic and economic predictions for the USSR. My dissertation [and 60% of my PHD — tutored by A.E. Gutnov] was called ‘The general patterns of territorial expansion of major cities’.</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>Vasya — shouting after her: ‘Darling, the concept has changed! I’ve shat myself.’</p>
        </div>
        <div className={styles.laconismUnit}>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>A concept is a system of understanding or a system used to solve a design problem. In architecture — it’s more of an additional limitation, that aids the architect to formulate and execute his idea more clearly.</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>The art and the science of building. ‘Functionality, durability, beauty.’ [Vitruvius]</p>
          <p>What then is the main characteristic of architecture?</p>
          <p>Architecture is the hole within a bagel.</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <ol>
            <li>External — a mountain — exterior.</li>
            <li>Internal — a cave — interior.</li>
            <li>Interim — a forest — surroundings.</li>
          </ol>
          <p>The proportional relationship between these spaces, as well as the connections that unite them is what creates architectural imagery. This imagery can conjure up emotions and feelings. Like in painting, where colour combinations are synthesized into different compositions to create imagery.</p>
        </div>
        <div className={styles.laconismUnit}>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>Let’s assume that the bagel got eaten. What happens to space then? It dissolves into nothingness. This means that space can not exist without its walls.</p>
        </div>
        <div className={styles.laconismUnit}>
          ...
          <p>In the modern world, eternity has taken on a new meaning. Eternity is now equal to present day requirements. In comparison to ancient masterpieces, architecture has become disposable. It does not meant that the fairy tale straw house built by the three little pigs has taken the world of architecture by storm. Nor does it mean that people will go to live in storage boxes. Either way, 200 years — is a substantial amount of time for future generations to rethink.</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <ol>
            <li>Green design and sustainable technologies. [These are just materials.]</li>
            <li>Smart and automated houses. [This is technological progress, not architecture.]</li>
            <li>The kitchen as the main course. [Not new — F.L. Wright.]</li>
            <li>The bathroom as a space for relaxation. [Already done — in palaces.]</li>
            <li>The development of an industrial style. [This is plain stupidity, not a style.]</li>
            <li>A new minimalism. [Laconism.]</li>
            <li>Reformation and restoration of historic and industrial buildings. [Not new — loft.]</li>
            <li>Less noise, more light. [Not new.]</li>
            <li>Development of outdoor spaces, landscaping. [Interim spaces have always been there.]</li>
            <li>The passive house. [Not new — energy efficiency.]</li>
          </ol>
        </div>
        <div className={styles.laconismUnit}>
          <h2 className={styles.laconismTitle}>architecture, fashion, style</h2>
          <p>The devil showed us fashion and went down under, lashing [my grandma, may she rest in peace].</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>A building is so much more than just a seasonal outfit, it encapsulates all of life’s processes. You can’t just throw it away, like an uncomfortable shoe. It will stand there and it will ruin everyone’s lives.</p>
        </div>
        <div className={styles.laconismUnit}>
          ...
          <p>Life nest to the wall is the homeless. Life behind the wall is what everyone dreams about. In truth, the wall is inside our lives. [1985—2020].</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>The client is always wrong. Wrong by definition, because he is seeking help from a professional. [Otherwise, he wouldn’t need an architect and would be able to build whatever he needs by himself.]</p>
          <p>He know what he wants. But he doesn’t know what he needs.</p>
          <p>The aim is to find the one and only optimum design solution. If you do this correctly, it will always be beautiful.</p>
          <p>In order to create a reverse brief, it’s important to gradually exclude all of the client’s ‘empty wants’ and to leave only the things that he can’t live without. This will form the perfect guidelines. the main principles of working with the client are always based on understanding, trust and mutual responsibility on both sides.</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>Correct distribution of investor’s funds for maximum result.</p>
          <p>Design happens in two main stages:</p>
          <ol>
            <li>Preparation + concept design + economic grounds to determine budget [what we are building].</li>
            <li>Project documentation + quotations + schedule [how we are building it].</li>
          </ol>
        </div>
        <div className={styles.laconismUnit}>
          ...
          <ol>
            <li>Development and agreement of all technical processes on site, in advance, with the general contractor.</li>
            <li>Execution.</li>
            <li>Amendment of technical drawings if necessary.</li>
            <li>Strict and regular surveillance of all works at all stages, with zero compromise.</li>
          </ol>
        </div>
        <div className={styles.laconismUnit}>
          <h2 className={styles.laconismTitle}>the key players</h2>
          <ul>
            <li>a. Client-developer-investor [one person].</li>
            <li>b. Author-architect [one person].</li>
            <li>c. Contractor-general/contractor [one person] + subcontractors.</li>
          </ul>
          <p>This triangle works like a Kalashnikov. The only condition is that the first two have to be on the same level, with the contractor subordinate to them both. I even used this system abroad. Unfortunately, I did come across some unpleasant nuances. Some contractors prefer rest over work. Sometimes I had to bring in my own team to finish.</p>
        </div>
        <div className={styles.laconismUnit}>
          <h2 className={styles.laconismTitle}>professional communications</h2>
          <ul>
            <li>Publications [online and physical]</li>
            <li>Exhibitions</li>
            <li>Lectures</li>
            <li>Competitions [In recent years, everything became internet-based, including the voting process. This is not right.]</li>
          </ul>
        </div>
        <div className={styles.laconismUnit}>
          <h2 className={styles.laconismTitle}>exhibitions</h2>
          <p>We should return to having physical exhibitions, so that the participants and the spectators can see all the works in the same format, on one wall. It would be best to have presentations to introduce the projects and then discussions. Judging should also be done within the gallery.</p>
        ...
        <div className={styles.laconismUnit}>
          ...
          <p>This approach can never accommodate architecture as an art form.</p>
        ...
        <div className={styles.laconismUnit}>
          <h2 className={styles.laconismTitle}>architecture is an art, not a business</h2>
          <p>In terms of profit, art is a minus, and business is a plus.</p>
          <p>Architecture always has and always will develop according to the needs of man and society, with a caring attitude towards nature.</p>
        </div>
        <div className={styles.laconismUnit}>
          <h2 className={styles.laconismTitle}>laconism <span className='nowrap'>[in short]</span></h2>
          <ul className={styles.laconismList}>
            <li className={styles.laconismItem}>
              <p>Style = the art of living. Fashion = the search of a new style.</p>
            </li>
            <li className={styles.laconismItem}>
              <p>Architecture = functionality + strength + beauty [Vitruvius]. Architectural space = the hole in the centre of a ring doughnut.</p>
            </li>
            <li className={styles.laconismItem}>
              <p>Laconism [as a style] = living within what is necessarily sufficient. Laconism [in architecture] = the necessary sufficiency of functionality + strength + beauty.</p>
            </li>
            <li className={styles.laconismItem}>
              <p>Painting = the outburst of an artist’s emotions onto a two dimensional plane. Sculpture = the outburst of an artist’s emotions onto a three dimensional form. Architecture = the outburst of an architect’s emotions onto the walls that form space.</p>
            </li>
          </ul>
        </div>
        <div className={styles.laconismUnit}>
