    ...
    <section className={styles.bio}>
      ...
      <div className={styles.bioWrapper}>
        <div className={styles.bioTextUnit}>
          ...
          <q>We were taught primarily academic drawing and painting skills. This was done in order to develop motor skills and form a connection between what you have in mind and the hand that embodies your idea.</q>
          ...
          <q>We were not allowed to build. We wrote books, defended our doctoral theses, and ‘played’ in conceptual competitions announced by The Japan Architect magazine. We couldn’t even imagine that one day we would be able to build our own projects, so we put our thoughts on paper in the form of architectural symbols and images with the aim of awakening a faceless environment filled with the soviet mass culture.</q>
          <MoreButton to='/architecture/publications/paper'>more about paper architecture</MoreButton>
        </div>
        ...
        <div className={styles.bioTextUnit}>
          ...
          <q>An architectural project is just an idea, an illusion of a project that still needs to be turned into reality. An architect is always both a composer and a conductor. It’s not enough to come up with a concept and agree on it with the client: if you don’t conduct the whole process, someone is bound to mess up and play out of tune. Builders are like-minded people. Together with the architect, who guides their craftsmanship, they create the art of architecture.</q>
          ...
          <q>For me, architecture is like a hole in a bagel. It is a space for human activity, created with the help of walls and other architectural elements. Everything superfluous is cut off from the customer’s ‘wishes’, leaving only what is necessary, without which he cannot live. The architect’s task is to find the only correct solution, which the person himself does not yet realise. The client is always wrong, which is why they turned to a professional for help.</q>
          ...
          <q>Space cannot exist without walls. But in reality, walls exist only in our minds. They are obstacles that we create for ourselves and then heroically overcome. My creativity is both a struggle against walls and a wall in life. A bad painting or sculpture can be put away in a closet, a film can be ignored, music can be ignored, but architecture cannot be hidden because we live in it.</q>
          ...
          <q>For some reason, it is now commonly believed that architects only design the ‘box’ and then invite designers, furniture makers and decorators to complete the project. But it is impossible to achieve the right perception and execute part of a work well if you do not understand and love it as a whole. Antoni Gaudí and Fyodor Schechtel designed and thought through everything in their projects, right down to the door handles.</q>
          <MoreButton to='/architecture/projects'>more about projects</MoreButton>
        </div>
        <div className={styles.bioTextUnit}>
          ...
          <q>The display is a palette where colours are mixed, the computer mouse replaces the brush, and the printer applies the paint to the canvas. In my work, I use all the techniques and principles of traditional painting, but I add modern technologies that allow me to make the colour cleaner and deeper and to convey the entire range of shades available to our eyes as accurately as possible.</q>
          ...
          <q>Painting — is the outburst of an artist’s emotions onto a two dimensional plane. A painting destroys the wall on which it hangs, creating a new world within it. A classic example of this is Leonardo da Vinci’s ‘The Last Supper’, where the perspective of the hall continues into the canvas itself, thus breaking the plane of the wall and immersing us in the infinity of contemplation.</q>
          ...
          <q>For me, there is no difference between representational and abstract art. Real art is when you look at a work and don’t know how it was made, how the artist or architect, using only images and space, evokes these feelings in you.</q>
          <MoreButton to='/paintings'>more about paintings</MoreButton>
        </div>
      </div>
      <GalleryLightbox
        open={open}
